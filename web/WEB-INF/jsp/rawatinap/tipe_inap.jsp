...
<div style="" class="o-flex-grid w-100">
    <div class="o-flex-grid--item">
<%if(resp1 != null){%>
    <p style="background: #28a745; color:white"> Pasien Berhasil ditambah</p>
<%}%>
<h2> Daftar Kamar </h2>
            ...
            <tbody>
                <tr class="pure-table-odd" >
                    ...
                    <td>
                            ...
                            <a <%if(detailKamar.getInt(id+"1")==0){out.print("disabled");}%> style="font-size:70% ;  background-color:#fdca40" class="pure-button"   href="?act=tambah-inap&tipe=<%=idTemp[1]%>&id=1"><b><strong>Tambah Pasien</strong></b></a>
                    </td>
                </tr>
                <tr class="pure-table-odd" >
                    <td>2</td>
                    ...
                    <td>
                            ...
                            <a <%if(detailKamar.getInt(id+"2")==0){out.print("disabled");}%>  style="font-size:70% ;  background-color:#fdca40" class="pure-button" href="?act=tambah-inap&tipe=<%=idTemp[1]%>&id=2"><b><strong>Tambah Pasien</strong></b></a>
                    </td>
                </tr>
                <tr class="pure-table-odd" >
                    <td >3</td>
                    ...
                    <td>
                            ...
                            <a <%if(detailKamar.getInt(id+"3")==0){out.print("disabled");}%>   style="font-size:70% ;  background-color:#fdca40" class="pure-button" href="?act=tambah-inap&tipe=<%=idTemp[1]%>&id=3"><b><strong>Tambah Pasien</strong></b></a>
                    </td>
                </tr>
                <tr class="pure-table-odd" >
                    <td >4</td>
                    ...
                    <td>
                            ...
                            <a <%if(detailKamar.getInt(id+"4")==0){out.print("disabled");}%>   style="font-size:70% ;  background-color:#fdca40" class="pure-button" href="?act=tambah-inap&tipe=<%=idTemp[1]%>&id=4"><b><strong>Tambah Pasien</strong></b></a>
                    </td>
                </tr>
                <tr class="pure-table-odd" >
                    <td>5</td>
                    ...
                    <td>
                            ...
                            <a <%if(detailKamar.getInt(id+"5")==0){out.print("disabled");}%>   style="font-size:70% ;  background-color:#fdca40" class="pure-button" href="?act=tambah-inap&tipe=<%=idTemp[1]%>&id=5"><b><strong>Tambah Pasien</strong></b></a>
                    </td>
                </tr>
            </tbody>
        </table>
